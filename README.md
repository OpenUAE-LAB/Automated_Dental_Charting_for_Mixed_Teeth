...
These images are provided for reproducibility and demonstration only, are not used for model training or evaluation, and have been annotated by the authors for YOLO formatting.
...
© Original dataset authors (CC BY 4.0). Modifications by authors of this paper.
